...
public class Main {
	public static void main(String[] args) throws NotUniqueIdException, NotFoundException, IOException {
		...
		try {
			bankService.create(new Bank(1, "Сбер"));
			bankService.create(new Bank(2, "Тинькоф"));
			bankService.create(new Bank(3, "Альфа"));
			bankService.create(new Bank(4, "Открытие"));
